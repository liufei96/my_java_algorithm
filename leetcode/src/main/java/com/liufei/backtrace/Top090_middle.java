...
public class Top090_middle {
    ...
    static void backtrace(int[] nums, int begin, boolean[] used, List<Integer> list, List<List<Integer>> res) {
        ...
        for (int i = begin; i < nums.length; i++) {
            ...
            list.add(nums[i]);
            used[i] = true;
            backtrace(nums, i + 1, used, list, res);
